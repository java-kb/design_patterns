package me.study.designpatterns.creational.prototype.gui.example01_graphic_editor.version3.prototype;
...
public class PrototypeManager implements Serializable {
    ...
    /**
     * Add a new circle to the list of prototypes
     *
     * @param newPrototype the new circle
     */
    public static void add(GraphicIF newPrototype) {
