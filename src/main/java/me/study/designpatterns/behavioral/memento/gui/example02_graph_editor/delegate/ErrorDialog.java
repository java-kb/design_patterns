...
public class ErrorDialog extends javax.swing.JDialog {
    ...
    /**
     * The dialog as tabbed pane
     */
    private final JTabbedPane tbbErrorDialog = new JTabbedPane();

    /**
     * Private constructor. Builds the base for the dialog, the individual tabs
     * will be filled by other constructors
     */
    private ErrorDialog() {
        super();
        ...
        btnExit.addActionListener((var e) -> {
            dispose();
        });
