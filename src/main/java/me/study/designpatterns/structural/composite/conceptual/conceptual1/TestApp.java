package me.study.designpatterns.structural.composite.conceptual.conceptual1;
...
public class TestApp {
    public static void main(String[] args) {
        ...
        System.out.print("Client: I don't need to check the components classes even when managing the tree:\n");
...
class Client {
    ...
    public void ClientCode(Component leaf) {
        System.out.println("RESULT: " + leaf.Operation());
    }
